...
contract('KaziKrypto', (accounts) => {
    ...
    it('should add a new freelancer', async () => {
        ...
        await instance.addNewFreelancer(fullName, hourlyRate, profession, preferredPayment, skills, { from: accounts[0] });
    ...
    it('should add a new portfolio to freelancer', async () => {
        ...
        await instance.addPortfolio(images, videos, taskUrl, description, { from: accounts[0] });
    ...
    it('should add a new experience to freelancer', async () => {
        ...
        await instance.addFreelancerExperience(fromDate, toDate, jobTitle, jobDescription, { from: accounts[0] });
    ...
    it('should make a new bidding and retrieve it', async () => {
        ...
        await instance.makeABidding(jobId, bidDescription, budget, relevantFiles, { from: accounts[1] });
    ...
    it('should send a chat and mark as read', async () => {
        ...
        await instance.chat(receiver, message, attachedFiles, { from: accounts[0] });
